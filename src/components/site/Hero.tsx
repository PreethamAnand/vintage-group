    ...
    <section id="home" className="relative bg-background overflow-hidden">
      ...
      <div className="relative min-h-[100svh] flex items-center">
        ...
        <div className="absolute bottom-0 inset-x-0 bg-primary text-primary-foreground z-10">
          <div className="container-px mx-auto max-w-7xl py-6 md:py-6">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-y-6 gap-x-4 md:divide-x md:divide-accent/30">
            {FEATURES.map((f, i) => {
              const Icon = f.icon;
              return (
                <div
